      ...
      for (const p of products) {
        ...
        if (existing) {
          ...
          /* handle is deliberately absent from this SET — channel and
             ...
             per-variant vendor_id resolution below; cost lives there too,
             on every product, including "In-house" ones (schema.sql's own
             comment on mirror_product.commission_pct). */
          await run(
